        ...
        <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
            <div class="col-first">
                ...
                <nav class="d-flex align-items-center">
                    ...
                    <a href="single-product.html">Chi tiết sản phẩm</a>
                </nav>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6">
                <div class="s_Product_carousel">
                    <div class="single-prd-item">
                        <img class="img-fluid" src="../../contents/client/img/category/s-p1.jpg" alt="">
                    </div>
                    <div class="single-prd-item">
                        <img class="img-fluid" src="../../contents/client/img/category/s-p1.jpg" alt="">
                    </div>
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    ...
                    <div class="product_count">
                        ...
                        <button
                                onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst )  &amp || sst > 0 ) result.value--;return false;"
                    ...
                    <div class="col-lg-12">
                        <div class="comment_list">
                            <div class="review_item">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="../../contents/client/img/product/review-1.png" alt="">
                                    </div>
                            ...
                            <div class="review_item reply">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="../../contents/client/img/product/review-2.png" alt="">
                                    </div>
                                    <div class="media-body">
                                        <h4>Blake Ruiz</h4>
                                        <h5>12th Feb, 2018 at 05:56 pm</h5>
                            ...
                            <div class="review_item">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="../../contents/client/img/product/review-3.png" alt="">
                                    </div>
                                    <div class="media-body">
                                        <h4>Blake Ruiz</h4>
                                        <h5>12th Feb, 2018 at 05:56 pm</h5>
            ...
            <div class="col-lg-3">
                <div class="ctg-right">
                    <a href="#" target="_blank">
                        <img class="img-fluid d-block mx-auto" src="../../contents/client/img/category/c5.jpg" alt="">
                    </a>
                </div>
            </div>
        </div>
