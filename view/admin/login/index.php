        ...
        <div class="col-md-4 col-sm-8 mx-auto p-5 backgound-login border border-info rounded ">
            <div class="row mb-3">
                <div class="top-image col-12 d-flex justify-content-center align-items-center">
                    <img src="../../../uploads/images-logo/ADMIN.png" alt="">
                ...
                <div class="col-12">
                    <form>
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <label class="form-check-label" for="exampleCheck1">Đồng ý với điều khoản</label>
                        </div>
                        <div class="button-login">
                            <a href="#">
                                <button type="submit" class="btn btn-primary">Quên mật khẩu</button>
                            </a>
                            <button type="submit" class="btn btn-success">Đăng nhặp</button>
                        </div>
                    </form>
                </div>
