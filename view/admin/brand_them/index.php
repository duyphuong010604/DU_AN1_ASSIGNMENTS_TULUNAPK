                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="../backend/loaisp-xuly.php" method="post">
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="loaisp">Tên thương hiệu</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                        <span id="loaisp" class="input-group-text"><i
                                                                    class='bx bxl-product-hunt'></i></span>
                                                    <input type="text" class="form-control" id="loaisp"
                                                           placeholder="Tên thương hiệu" name="loaisp" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" id="origi"
                                                           placeholder="Xuất xứ thương hiệu" value=""
                                                           name="origi"/>
                                                </div>
                                            </div>
                                        </div>
