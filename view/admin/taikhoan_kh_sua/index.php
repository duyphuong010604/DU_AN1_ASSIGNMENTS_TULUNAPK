                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="../backend/khachhang-sua.php" method="post">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    <span id="id_kh" class="input-group-text"><i
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="username">Ảnh đại
                                                diện</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge ">
                                                    <span id="username" class="input-group-text"><i
                                                                class='bx bxs-image-alt'></i></span>
                                                    <div class="border border-image ">
                                                        <img src="../../../uploads/images-logo/TULUNA PK.png" alt=""
                                                             height='50px'>
                                                    </div>
                                                </div>
                                            </div>
