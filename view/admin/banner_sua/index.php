                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="../backend/loaisp-sua.php" method="post">
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label">ID Banner</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    <span id="loaisp" class="input-group-text"><i
                                                                class='bx bx-category'></i></span>
                                                    <input type="text" class="form-control" id="id_lsp" required
                                                           readonly name="id_lsp" value=""/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="ten">Tiêu đề Banner</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    <span id="loaisp" class="input-group-text"><i
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="n">Nội dung Banner</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    <span id="loaisp" class="input-group-text"><i
                                                                class='bx bx-text'></i></span>
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <select name="trangthai" id="trangthai"
                                                        ...
                                                        <option class="form-control" value="Hiển thị">Hiển thị
                                                        </option>
