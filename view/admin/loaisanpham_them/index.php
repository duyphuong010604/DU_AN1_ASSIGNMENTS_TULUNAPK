            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Quản lí loại sản phẩm /
                                Thêm mới loại sản phẩm </span> / Thêm mới loại sản phẩm</h4>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="../backend/loaisp-xuly.php" method="post">
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="loaisp">Tên loại sản
                                                phẩm</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" id="loaisp"
                                                           placeholder="Tên loại sản phẩm" name="loaisp" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
