                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" id="ho"
                                                           placeholder="Họ và tên đệm" name="ho" required/>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" id="diachi" class="form-control"
                                                           ...
                                                           aria-describedby="diachi" name="diachi" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <select name="trangthai" id="trangthai"
                                                        ...
                                                        <option class="form-control" value="Cho phép">Cho phép
                                                        </option>
