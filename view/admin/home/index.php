                                ...
                                <div class="d-flex align-items-end row">
                                    ...
                                    <div class="col-sm-5 text-center text-sm-left">
                                        <div class="card-body pb-0 px-0 px-md-4">
                                            <img src="<?= $CONTENT_URL ?>/admin/assets/img/illustrations/man-with-laptop-light.png"
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div
                                                    class="card-title d-flex align-items-start justify-content-between">
                                                <div class="avatar flex-shrink-0">
                                                    <img src="<?= $CONTENT_URL ?>/admin/assets/img/icons/unicons/paypal.png"
                                                         alt="Credit Card" class="rounded"/>
                                                </div>
                                                <div class="dropdown">
                                            ...
                                            <span class="d-block mb-1">Đơn chuyển khoản</span>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div
                                                    class="card-title d-flex align-items-start justify-content-between">
                                                <div class="avatar flex-shrink-0">
                                                    <img src="<?= $CONTENT_URL ?>/admin/assets/img/icons/unicons/cc-primary.png"
                                                         alt="Credit Card" class="rounded"/>
                                                </div>
                                                <div class="dropdown">
                                            ...
                                            <span class="fw-semibold d-block mb-1">Trả tiền mặt</span>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-title">
                                                        ...
                                                        <span class="badge bg-label-warning rounded-pill">Mua
                                                                xắm</span>
                                                    </div>
                            ...
                            <div class="card h-100">
                                <div class="card-header d-flex align-items-center justify-content-between pb-0">
                                    <div class="card-title mb-0">
                                        <h5 class="m-0 me-2">Thống kê các loại sản phẩm đã bán</h5>
                                    ...
                                    <div class="tab-content p-0">
                                        <div class="tab-pane fade show active" id="navs-tabs-line-card-income"
                                            ...
                                            <div class="d-flex p-4 pt-3">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="<?= $CONTENT_URL ?>/admin/assets/img/icons/unicons/wallet.png"
                                                         alt="User"/>
                                                </div>
                                                <div>
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <ul class="p-0 m-0">
                                        ...
                                        <li class="d-flex mb-4 pb-1">
                                            <div class="avatar flex-shrink-0 me-3">
                                                <img src="<?= $CONTENT_URL ?>/admin/assets/img/icons/unicons/chart.png"
                                                     alt="User" class="rounded"/>
                                            </div>
                                            <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        ...
                                        <li class="d-flex mb-4 pb-1">
                                            <div class="avatar flex-shrink-0 me-3">
                                                <img src="<?= $CONTENT_URL ?>/admin/assets/img/icons/unicons/cc-success.png"
                                                     alt="User" class="rounded"/>
                                            </div>
                                            <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        ...
                                        <li class="d-flex">
                                            <div class="avatar flex-shrink-0 me-3">
                                                <img src="<?= $CONTENT_URL ?>/admin/assets/img/icons/unicons/cc-warning.png"
                                                     alt="User" class="rounded"/>
                                            </div>
                                            <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
