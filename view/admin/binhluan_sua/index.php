                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="../backend/binhluan-sua.php" method='post'>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="noidung_bl">Nội dung bình
                                                luận</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                        <span id="noidung_bl" class="input-group-text"><i
                                                                    class='bx bx-text'></i></span>
                                                    <input type="text" class="form-control" id="noidung_bl"
                                                           placeholder="Nhập nội dung" name="noidung_bl"
                                                           value=""/>
                                                </div>
                                            </div>
                                        </div>
