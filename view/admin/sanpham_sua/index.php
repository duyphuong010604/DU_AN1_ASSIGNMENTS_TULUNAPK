                                ...
                                <div class="card-body">
                                    <form action="../backend/sanpham-sua.php" method="post"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                        <span id="id_sp" class="input-group-text"><i
                                                                    class='bx bx-fridge'></i></span>
                                                    <input type="text" class="form-control" id="id_sp"
                                                           aria-describedby="id_sp" required readonly name="id_sp"
                                                           value=""/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                        <span id="ten" class="input-group-text"><i
                                                                    class='bx bxl-product-hunt'></i></span>
                                                    <input type="text" class="form-control" id="ten"
                                                           aria-describedby="ten" required readonly name="ten"
                                                           value=""/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="">Thuộc loại sản
                                                phẩm</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    <select name="lsp" id="lsp" class="form-control form-select">
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="">Thuộc thương
                                                hiệu</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    <select name="brand" id="brand"
                                                        ...
                                                        <option disabled>Chọn</option>
                                                        <option class="form-control" value="Hiển thị">Hiển thị
                                                        </option>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                        <span id="basic-icon-default-password"
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="gia">Giá sale</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" id="size" class="form-control"
                                                           aria-describedby="size" name="size" value=""/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" id="view" class="form-control" readonly
                                                           name="view"/>
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <select name="trangthai" id="trangthai"
                                                            class="form-control form-select">
                                                        <option disabled>Chọn</option>
                                                        <option class="form-control" value="Hiển thị"></option>
                                                        >Hiển thị</option>
                                                        <option class="form-control" value="Ẩn">Ẩn</option>
                                                    </select>
                                                </div>
