        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="table-responsive text-nowrap p-1">
                            <table id="example" class="table mb-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="../../../uploads/images-background/free-photo-of-giay-giay-th-thao-ch-p-nh-th-i-trang-doi.jpeg"
                                             alt="Ảnh sản phẩm" height="80px">
                                    </td>
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="" data-bs-toggle="modal"
                                                   data-bs-target="#exampleModal-xoasp"><i
                    ...
                    <!-- Bootstrap Table with Header - Footer -->
                    <!-- Modal -->
                    <div class="modal fade" id="exampleModal-xoasp" tabindex="-1"
                         aria-labelledby="exampleModalLabel-xoasp" aria-hidden="true">
